...
When enabled, the Navigator exposes a `suggest_tools` MCP tool to your agent. Instead of scanning through a long list of tools, your agent describes what it wants to accomplish, and the Navigator returns a **ranked list of the most relevant tools** across all connected servers.
...
<Steps>
  <Step title="Navigate to Navigator Instance settings">
