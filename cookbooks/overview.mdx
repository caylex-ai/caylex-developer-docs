...
<CardGroup cols={2}>
  ...
  <Card title="Sync Notion files with a background agent" icon="file-export" href="/cookbooks/background-agent-file-sync">
    Discover and fetch Notion content, download the task's tool trace, and build resource-centric JSON for indexing.
  </Card>
