...
| `POST /api/v1/assistants/sessions/{session_id}/messages` | Send a normal user turn to an existing production session. See [Programmatic Chat Sessions](/cookbooks/programmatic-chat-sessions). |
