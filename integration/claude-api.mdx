...
async def main() -> None:
    ...
    messages = [
        {
            "role": "user",
            "content": "Check which services I can access, then summarize "
            "my recent research documents.",
        }
    ]
            ...
            async with ClientSession(read_stream, write_stream) as mcp:
                ...
                runner = claude.beta.messages.tool_runner(
                    ...
                    messages=[
                        {
                            "role": "user",
                            "content": "Check which services I can access, then "
                            "summarize my recent research documents.",
                        }
                    ],
                    tools=[
...
response = client.beta.messages.create(
    ...
    messages=[
        {
            "role": "user",
            "content": "Check my connected services and summarize my recent documents.",
        }
    ],
    mcp_servers=[
        {
