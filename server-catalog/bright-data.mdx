...
- Pro mode features (structured platform data, browser automation) require a paid Bright Data plan and must be enabled via the &pro=1 parameter.
...
| **Endpoint** | https://mcp.brightdata.com/mcp?token=<YOUR_API_TOKEN> |
